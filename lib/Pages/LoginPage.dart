...
class LoginPage extends StatelessWidget {
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Stack(
                children: [
                  Center(child: Text("Don't have an account?", style: TextStyle(color: Theme.of(context).colorScheme.inversePrimary),)),
                  Center(child: TextButton(onPressed: (){
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => RegistrationPage()));
                  }, child: Text("You can create one!")))
                ],
              )
            ],
          ),
  ...
  Widget _createLoginButton(BuildContext context) {
    return TextButton(
      onPressed: () {
        _registrationService.loginUser(
